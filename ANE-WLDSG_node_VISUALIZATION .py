...
with open('WLk_facebook', 'wb') as f:
     pickle.dump(trget, f) 
...
#====================================================================================== 
with open('WL_facebook.npy', 'wb') as f:
...
#=============================================================================VISUALIZATION 
X_train, X_test, y_train, y_test = train_test_split(X2, target, test_size=20/100) 
...
z=tsne.fit_transform(encoded_ts)
df=pd.DataFrame()
df["y"]=y_test
df["co-1"]=z[:,0]
df["co-2"]=z[:,1]
sns.scatterplot(x="co-1",y="co-2",hue=y_test,palette=sns.color_palette("hls",2),data=df).set(title="facebook")
